...
<body>
  <h1>Mercadinho</h1>
    <form action="produto.php" method="get">
      ...
      <input type="text" name="codproduto" id='codproduto' placeholder="99.999"><br>

      <label for="descricao">Descrição</label>
      <input type="text" name="descricao" id='descricao' placeholder="Descrição do seu produto"><br>
      ...
      <option value ="03-4">03- 4% Higiene </option>
      </select>
